...
void fileEntry() {
  tempf = headf;
  char tname[100];
  char path[] = "C:\\Users\\ishika\\Documents\\Travalista\\USERS\\";
  strcpy(tname, path);
...
//taking details of the node
 ...
 printf("\n\t\t\t**************************************************\n");
  ...
  FILE*f;
  f=fopen("C:\\Users\\ishika\\Documents\\Travalista\\FLIGHT FILES\\ticket.txt","w");
...
FILE*fp;
fp=fopen("C:\\Users\\ishika\\Documents\\Travalista\\FLIGHT FILES\\allrecords.txt","a");
struct node*temp;
...
void display() {
  ...
  system("cls");
    ...
    system("cls");
    FILE *f;
    f=fopen("C:\\Users\\ishika\\Documents\\Travalista\\FLIGHT FILES\\Flights.txt","r");
...
void hotelPrinting(char country[]) {
  clrscr();
  char path[100] = "C:\\Users\\ishika\\Documents\\Travalista\\COUNTRY\\"; int choice;
  strcat(path, country);
  strcat(path, ".txt");
...
void fileToList() {
  ...
  FILE *fp = fopen("C:\\Users\\ishika\\Documents\\Travalista\\Database.txt", "r");
  while(!feof(fp)) {
...
void createUser() {
  ...
  temp->next = NULL;
  FILE *fp = fopen("C:\\Users\\ishika\\Documents\\Travalista\\Database.txt", "a");
